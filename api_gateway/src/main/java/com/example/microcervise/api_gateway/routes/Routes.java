package com.example.microcervise.api_gateway.routes;
    ...
    public RouterFunction<ServerResponse> productServiceRoute() {
        return route("product_service")
                .nest(RequestPredicates.path("/products"), builder -> builder
                        .route(RequestPredicates.path("/add"), HandlerFunctions.http("http://localhost:8080"))
                        .route(RequestPredicates.path(""), HandlerFunctions.http("http://localhost:8080"))
